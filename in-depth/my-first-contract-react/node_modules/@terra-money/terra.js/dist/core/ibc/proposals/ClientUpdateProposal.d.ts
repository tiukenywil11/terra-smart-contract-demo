...
export declare class ClientUpdateProposal extends JSONSerializable<ClientUpdateProposal.Amino, ClientUpdateProposal.Data, ClientUpdateProposal.Proto> {
    ...
    static fromAmino(data: ClientUpdateProposal.Amino): ClientUpdateProposal;
    toAmino(): ClientUpdateProposal.Amino;
    static fromData(data: ClientUpdateProposal.Data): ClientUpdateProposal;
    toData(): ClientUpdateProposal.Data;
    static fromProto(proto: ClientUpdateProposal.Proto): ClientUpdateProposal;
    toProto(): ClientUpdateProposal.Proto;
    packAny(): Any;
    static unpackAny(msgAny: Any): ClientUpdateProposal;
}
